...
insert overwrite directory '/user/hduser/Banking_Insurance/middlegrademaskedout' select concat(issuerid,',',businessyear,',',statedesc,',',sourcename,',',maskednetworkurl,',',sex,',',grade,',',marital,',',newbillamt,',',defaulter) from middlegradeview;